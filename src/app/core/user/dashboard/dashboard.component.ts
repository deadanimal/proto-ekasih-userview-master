...
export class DashboardComponent implements OnInit, OnDestroy {
  ...
  getCharts() {
    this.zone.runOutsideAngular(() => {
      this.getChartDashboardUserPie1()
      this.getChartDashboardUserGroupedSorted1()
    })
  }

  getChartDashboardUserPie1 () {
    /* Chart code */
    // Themes begin
    ...
    chart.data = [ {
      ...
      "country": "Program Yang Diterima oleh KIR",
      "litres": 201.1
    }, ];
  ...
  getChartDashboardUserGroupedSorted1 () {
    /* Chart code */
    // Themes begin
    ...
    let chart = am4core.create("chartdashboardgroupedsorted1", am4charts.XYChart);
