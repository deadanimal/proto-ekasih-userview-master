...
@Component({
  selector: 'app-kemaskini-maklumat-bantuan',
  templateUrl: './kemaskini-maklumat-bantuan.component.html',
  styleUrls: ['./kemaskini-maklumat-bantuan.component.scss']
})
export class KemaskiniMaklumatBantuanComponent implements OnInit {
  ...
  successSwal() {
    swal.fire({
      title: "Simpanan maklumat berjaya!",
      //text: "",
      type: "success",
